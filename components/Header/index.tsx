  ...
  return (
    <motion.section className="w-full" initial="initial" animate="animate">
      ...
      <motion.a
        ...
        whileHover={{ y: -2, x: 4 }}
        className="mr-3  mt-3 inline-flex items-center gap-2 py-1 text-slate-400 transition hover:text-blue-300 active:text-blue-300"
      >
